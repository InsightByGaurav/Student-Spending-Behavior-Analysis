...
* Number of responses: (add your number)
* Data includes:
...
* Converted categorical ranges into numerical values
...
* Higher allowance leads to higher spending
* Discounts influence spending behavior
* Many students do not follow saving habits
